...
import com.vijay.jsonwizard.widgets.FromAccountViewFactory;
...
import com.vijay.jsonwizard.widgets.ToAccountViewFactory;
...
public class JsonFormInteractor {
    ...
    private void registerWidgets() {
        map.put(JsonFormConstants.FROM_ACCOUNT, new FromAccountViewFactory());
        map.put(JsonFormConstants.TO_ACCOUNT, new ToAccountViewFactory());
    }
